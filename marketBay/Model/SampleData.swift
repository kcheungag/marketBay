...
struct SampleData {
    static func generateSampleListings() -> [Listing] {
        ...
        let sampleListings: [Listing] = [
            ...
            Listing(id: 2, title: "Sample Listing 2", description: "Another sample listing description.", category: .homeAndGarden, price: 49.99, seller: user1, email: user1.email, phoneNumber: user1.phoneNumber),
            Listing(id: 3, title: "Sample Listing 3", description: "Yet another sample listing description.", category: .mensClothing, price: 29.99, seller: user1, email: user1.email, phoneNumber: user1.phoneNumber),
            Listing(id: 4, title: "Sample Listing 4", description: "More sample listing description.", category: .toys, price: 19.99, seller: user1, email: user1.email, phoneNumber: user1.phoneNumber),
            ...
            Listing(id: 7, title: "Sample Listing 7", description: "Another description for a sample listing.", category: .homeAndGarden, price: 79.99, seller: user2, email: user2.email, phoneNumber: user2.phoneNumber),
            ...
            Listing(id: 9, title: "Sample Listing 9", description: "Another description for a sample listing.", category: .toys, price: 9.99, seller: user3, email: user3.email, phoneNumber: user3.phoneNumber),
            Listing(id: 10, title: "Sample Listing 10", description: "Another description for a sample listing.", category: .womensClothing, price: 39.99, seller: user3, email: user3.email, phoneNumber: user3.phoneNumber)
        ]
